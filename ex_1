...
#Este trecho preenche 'manualmente' as entradas da matriz de interações
...
perceptron_matrix[3, 2] <- 1
perceptron_matrix[3, 3] <- 1
perceptron_matrix[3, 4] <- 1
perceptron_matrix[4, 1] <- -1
perceptron_matrix[4, 3] <- 1
perceptron_matrix[5, 1] <- 1
perceptron_matrix[5, 4] <- 1
perceptron_matrix[2, 1] <- -1
perceptron_matrix[3, 5] <- -1
perceptron_matrix[5, 2] <- -1
...
ggnet2(network(adj, directed = TRUE), label = 0:31, arrow.size = 8, arrow.gap = 0.025)
